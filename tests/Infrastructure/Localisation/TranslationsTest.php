    ...
    public function testAllTranslationsHaveBeenExtracted(): void
    {
        ...
        foreach (Locale::cases() as $locale) {
            ...
            if (!file_exists($translationFilePath)) {
                $this->fail(sprintf('Not all translations for locale %s have been exported. Please run make console arg="translation:extract --force --prefix="" %s --format=yaml"', $locale->value, $locale->value));
            }
            ...
            $this->assertEqualsCanonicalizing(
                ...
                sprintf('Not all translations for locale %s have been exported. Please run make console arg="translation:extract --force --prefix="" %s --format=yaml"', $locale->value, $locale->value)
            );
        }
